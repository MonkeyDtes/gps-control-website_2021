...
import burbujas_arriba_mobile from "../../assets/Componentes/Iconos_pantalla/burbujas_arriba_mobile.png"
import "./Flecha_arriba.css";
...
function Flecha_arriba() {
    return ( <div className="cont--red--flecha__arriba">
        ...
        <img className="img--burbujas--flechaAbajo_mobile" src={burbujas_arriba_mobile} alt="" />
    </div>
  );
}
